...
class WebDischargeresidentsdetails extends StatelessWidget {
  const WebDischargeresidentsdetails({super.key, required this.uid});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebDischargeResidentsDetailsPageFormWidget(
        uid: uid,
      ), // pass UID to form
    );
  }
...
class WebDischargeResidentsDetailsPageFormWidget extends StatefulWidget {
  final String uid;

  const WebDischargeResidentsDetailsPageFormWidget({
    super.key,
    required this.uid,
  });

  @override
  State<WebDischargeResidentsDetailsPageFormWidget> createState() =>
      _WebDischargeResidentsDetailsPageFormWidgetState();
}

class _WebDischargeResidentsDetailsPageFormWidgetState
    extends State<WebDischargeResidentsDetailsPageFormWidget> {
