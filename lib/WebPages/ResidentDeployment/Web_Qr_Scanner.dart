...
import 'package:evacutaion/WebPages/ResidentDeployment/WebShowResidentsDetails.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:mobile_scanner/mobile_scanner.dart';
import 'package:supabase_flutter/supabase_flutter.dart';

class WebScanQrPage extends StatefulWidget {
  const WebScanQrPage({super.key});

  @override
  State<WebScanQrPage> createState() => _WebScanQrPageState();
}

class _WebScanQrPageState extends State<WebScanQrPage> {
      ...
      if (response != null) {
        ...
        if (status == 'Active') {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => WebShowRegistrationPage(uid: response['UID']),
            ),
          );
        } else {
  ...
  void _onDetect(BarcodeCapture capture) {
    if (capture.barcodes.isNotEmpty) {
      ...
      if (value != null && value != scannedResult && !_isSearching) {
          ...
          child: ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (_) => WebShowRegistrationPage(uid: record['UID']),
                ),
              );
            },
          ),
