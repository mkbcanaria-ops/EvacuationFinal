...
class AppMagsaysayEvacuationPage extends StatefulWidget {
  const AppMagsaysayEvacuationPage({super.key});

  @override
  State<AppMagsaysayEvacuationPage> createState() =>
      _AppMagsaysayEvacuationPageState();
}

class _AppMagsaysayEvacuationPageState
    extends State<AppMagsaysayEvacuationPage> {
