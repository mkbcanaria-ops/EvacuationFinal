...
class _AppSantaNationalHighSchoolResidentsPageState
  ...
  static const String currentSiteName = 'Santa National High School';
  ...
  Future<void> _dischargeSelectedResidents() async {
    ...
    for (final resident in selectedResidents) {
      ...
      if (didDischarge &&
          headName.isNotEmpty &&
          !dischargedNames.contains(headName)) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          "Santa National High School Residents",
          style: GoogleFonts.poppins(
              ...
              child: Center(
                child: Container(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const CircularProgressIndicator(color: Color(0xFF0D743D)),
                      const SizedBox(height: 14),
                      Text(
