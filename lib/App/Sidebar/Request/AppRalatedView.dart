import 'package:evacutaion/App/Sidebar/Request/App_ApprovedUser.dart';
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';

class AppRelatedHouseholdsPage extends StatelessWidget {
  final List<Map<String, dynamic>> households;

  const AppRelatedHouseholdsPage({super.key, required this.households});
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (_) => App_ApprovedUserQRPage(
