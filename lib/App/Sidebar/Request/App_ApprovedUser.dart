...
class App_ApprovedUserQRPage extends StatefulWidget {
  final String registrationId;
  final String firstName;
  final String middleName;
  final String lastName;

  const App_ApprovedUserQRPage({
    super.key,
  ...
  @override
  State<App_ApprovedUserQRPage> createState() => _App_ApprovedUserQRPageState();
}

class _App_ApprovedUserQRPageState extends State<App_ApprovedUserQRPage> {
