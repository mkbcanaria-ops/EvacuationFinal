...
class AppReportsPreviewPage extends StatefulWidget {
  ...
  @override
  State<AppReportsPreviewPage> createState() => _AppReportsPreviewPageState();
}

class _AppReportsPreviewPageState extends State<AppReportsPreviewPage> {
